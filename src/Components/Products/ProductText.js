        ...
        <Col md="12">
          {item.priceAfterDiscount >= 1 ? (
            <div className="product-price d-inline px-3 py-3 border">
              <span style={{ textDecorationLine: 'line-through' }}> {item.price}</span> {item.priceAfterDiscount} درهم
            </div>) : <div className="product-price d-inline px-3 py-3 border"><span> {item.price}</span> درهم </div>
          }
